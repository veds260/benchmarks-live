...
import { isSignedUp, setAuth } from "@/lib/auth";
        ...
        {loggedIn ? (
          <>
            <p className="text-sm text-text-secondary mb-4">
              You&apos;ve used all 20 AI-powered lookups for today.
              Browsing, sorting, and filtering are still free.
            </p>
            ...
            {onDismiss && (
              <button
                onClick={onDismiss}
                className="w-full py-2.5 px-4 bg-accent text-bg-primary font-semibold text-sm rounded-lg hover:bg-accent/90 transition-colors"
              >
                Continue browsing
              </button>
            )}
